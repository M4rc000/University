...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php } ?>
            <?php if($this->session->flashdata('edit_menu') != '') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    New has been added!
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
            ...
            <?php } ?>
            <?php if($this->session->flashdata('delete_menu') != '') { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url();?>menu/delete_menu/<?= $m['id']; ?>/" class="badge badge-danger">delete</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
