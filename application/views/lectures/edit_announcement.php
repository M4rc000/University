    ...
    <div class="row">
        <div class="col-lg-8">
            <form action="" method="post">
                ...
                <div class="form-group row">
                    <label for="announcement" class="col-sm-2 col-form-label">Descriptions</label>
                    <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="announcement" name="announcement"><?= $announcements['announcement']; ?></textarea>
