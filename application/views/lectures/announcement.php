...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Announcement Table</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md">
                    <?php if($this->session->flashdata('announcement') != '') { ?>
                      <div class="alert alert-success alert-dismissible fade show" role="alert">
                        Your announcement has been sent!
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                        <?php unset($_SESSION['announcement']); ?>
                      </div>
                    <?php } ?>
                  </div>
                  </div>
              ...
              <nav aria-label="Page navigation example">
                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?= form_open_multipart('lectures/edit_announcement'); ?>
                      <?php foreach($courses as $course): ?>
                        <tr class="text-center">
                            <td><?= $course['week']; ?></td>
                            <td><?= $course['course']; ?></td>
                            <td><?= $course['announcement']; ?></td>
                            <td><a href="<?= base_url();?>lectures/edit_announcement/<?= $course['id']; ?>/"><i class="bi bi-bookmark-plus"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?= base_url();?>lectures/delete_announcement/<?= $course['id']; ?>/"><i class="bi bi-trash"></i></a></td>
                        </tr>
                      <?php endforeach; ?>
                    </form>
                  </tbody>
